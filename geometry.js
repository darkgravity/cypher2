  ...
  function tileBoxPython(tileType, d1, d2, d3, d4, BBMin, BBMax) {
    ...
    const tileD1 = d1 ? (tileWidth / 10) * d1: 0, tileD2 = d2 ? (tileWidth / 10) * d2: 0, tileD3 = d3 ? (tileWidth / 10) * d3: 0, tileD4 = d4 ? (tileWidth / 10) * d4: 0;
    const tileS1 = d1 ? (origWidth / 10) * d1: 0, tileS2 = d2 ? (origWidth / 10) * d2 : 0, tileS3 = d3 ? (origHeight / 10) *d3: 0, tileS4 = d4 ? (origHeight / 10) *d4 : 0;
    const midX = BBMin.x + origWidth * 0.5, midY = BBMin.y + origHeight * 0.5, tileHeight = origHeight;
    switch (tileType) {
      case '01': return toLLUR(BBMin.x+tileS1, BBMin.y+tileS3, BBMax.x-tileS2, BBMax.y-tileS4);
      case '02': return toLLUR(BBMin.x, BBMin.y, BBMin.x + (tileD1*.5), BBMin.y + (tileD1*.5));
      case '03': return toLLUR(BBMax.x - (tileD1*.5), BBMin.y, BBMax.x, BBMin.y + (tileD1*.5));
      case '04': return toLLUR(BBMax.x - (tileD1*.5), BBMax.y - (tileD1*.5), BBMax.x, BBMax.y);
      case '05': return toLLUR(BBMin.x, BBMax.y - (tileD1*.5), BBMin.x + (tileD1*.5), BBMax.y); 
      case '06': return toLLUR(BBMin.x, BBMin.y + (tileD3*.5), BBMin.x, BBMax.y - (tileD4*.5));
      case '07': return toLLUR(BBMin.x, BBMin.y + (tileD3*.5), BBMin.x, BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '08': return toLLUR(BBMin.x, BBMin.y + (tileHeight * 0.5) + (tileD3*.5), BBMin.x, BBMin.y + tileHeight - (tileD4*.5));
      case '09': return toLLUR(midX, BBMax.y - (tileD4*.5), midX, BBMin.y + (tileD3*.5));
      case '10': return toLLUR(midX, BBMin.y + (tileD3*.5), midX, BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '11': return toLLUR(midX, BBMin.y + (tileHeight * 0.5) + (tileD3*.5), midX, BBMin.y + tileHeight - (tileD4*.5));
      case '12': return toLLUR(BBMax.x, BBMax.y - (tileD4*.5), BBMax.x, BBMin.y + (tileD3*.5));
      case '13': return toLLUR(BBMax.x, BBMin.y + (tileD3*.5), BBMax.x, BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '14': return toLLUR(BBMax.x, BBMin.y + (tileHeight * 0.5) + (tileD3*.5), BBMax.x, BBMax.y - (tileD4*.5));
      case '15': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y, BBMax.x - (tileD2*.5), BBMin.y);
      case '16': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y, midX - (tileD2*.5), BBMin.y);
      case '17': return toLLUR(midX + (tileD1*.5), BBMin.y, BBMax.x - (tileD2*.5), BBMin.y);
      case '18': return toLLUR(BBMin.x + (tileD1*.5), midY, BBMax.x - (tileD2*.5), midY);
      case '19': return toLLUR(BBMin.x + (tileD1*.5), midY, midX - (tileD2*.5), midY);
      case '20': return toLLUR(midX + (tileD1*.5), midY, BBMax.x - (tileD2*.5), midY);
      case '21': return toLLUR(BBMin.x + (tileD1*.5), BBMax.y, BBMax.x - (tileD2*.5), BBMax.y);
      case '22': return toLLUR(BBMin.x + (tileD1*.5), BBMax.y, midX - (tileD2*.5), BBMax.y);
      case '23': return toLLUR(midX + (tileD1*.5), BBMax.y, BBMax.x - (tileD2*.5), BBMax.y);
      case '24': return toLLUR(midX - (tileD1*.5), BBMin.y, midX, BBMin.y + (tileD1*.5));
      case '25': return toLLUR(midX, BBMin.y, midX + (tileD1*.5), BBMin.y + (tileD1*.5));
      case '26': return toLLUR(BBMax.x - (tileD1*.5), midY - (tileD1*.5), BBMax.x, midY);
      case '27': return toLLUR(BBMax.x - (tileD1*.5), midY, BBMax.x, midY + (tileD1*.5));
      case '28': return toLLUR(midX, BBMax.y - (tileD1*.5), midX + (tileD1*.5), BBMax.y);
      case '29': return toLLUR(midX - (tileD1*.5), BBMax.y - (tileD1*.5), midX, BBMax.y); 
      case '30': return toLLUR(BBMin.x, midY, BBMin.x + (tileD1*.5), midY + (tileD1*.5));
      case '31': return toLLUR(BBMin.x, midY - (tileD1*.5), BBMin.x + (tileD1*.5), midY);
      ...
      case '36': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileD3*.5), BBMax.x - (tileD2*.5), BBMax.y -(tileD4*.5));
      case '37': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileD3*.5), BBMax.x - (tileD2*.5), BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '38': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileHeight * 0.5) +  (tileD3*.5), BBMax.x - (tileD2*.5), BBMin.y + tileHeight - + (tileD4*.5));
      case '39': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileD3*.5), (BBMax.x  - (tileD2*.5))-(tileWidth * 0.5), BBMax.y-(tileD4*.5));
      case '40': return toLLUR((BBMin.x + (tileD1*.5))+(tileWidth * 0.5), BBMin.y + (tileD3*.5), (BBMax.x  - (tileD2*.5)), BBMax.y-(tileD4*.5));
      case '41': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileD3*.5), BBMin.x + (tileD2*.5), BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '42': return toLLUR(BBMax.x - (tileD1*.5), BBMin.y + (tileD3*.5), BBMax.x + (tileD2*.5), BBMin.y + (tileHeight * 0.5) - (tileD4*.5));
      case '43': return toLLUR(BBMin.x + (tileD1*.5), BBMin.y + (tileHeight * 0.5) +  (tileD3*.5), BBMin.x + (tileD2*.5), BBMin.y + tileHeight - + (tileD4*.5));
      case '44': return toLLUR(BBMax.x - (tileD1*.5), BBMin.y + (tileHeight * 0.5) +  (tileD3*.5),  BBMax.x + (tileD2*.5), BBMin.y + tileHeight - + (tileD4*.5));
